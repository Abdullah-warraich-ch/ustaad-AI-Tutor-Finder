...
export default function Hero() {
  ...
  return (
    <section className="relative w-full bg-gradient-to-t from-orange-100/90 via-orange-50/50 to-white text-slate-900 pt-28 pb-16 px-4 md:px-8 lg:px-16 overflow-hidden">
      
      {/* Dense Background Accent Orbs */}
      <div className="absolute top-12 right-[-5%] w-[32rem] h-[32rem] bg-[#FF4D00]/15 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-[-5%] w-[28rem] h-[28rem] bg-orange-300/30 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto w-full grid lg:grid-cols-12 gap-10 items-center">
        ...
        <div className="lg:col-span-7 space-y-6 text-left">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-semibold leading-[1.15] text-slate-900 tracking-tight">
        ...
        {/* Right Column (Vibrant Image Showcase) */}
        <div className="lg:col-span-5 flex justify-center">
          <div className="relative w-64 h-64 sm:w-80 sm:h-80">
            {/* Solid Color Back Drop */}
            <div className="absolute inset-0 bg-[#FF4D00] rounded-3xl transform translate-x-3 translate-y-3"></div>
